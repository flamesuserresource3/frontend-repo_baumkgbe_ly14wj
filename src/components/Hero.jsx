export default function Hero() {
  return (
    <section id="home" className="relative pt-24 md:pt-28 bg-white min-h-[80vh]">
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 min-h-[80vh] flex items-center justify-center">
        <div className="w-full max-w-5xl text-center">
          ...
          <div className="w-full aspect-video rounded-2xl border border-black/10 overflow-hidden shadow-sm mx-auto mt-8 md:mt-10 bg-white">
            <iframe
              width="100%"
              height="100%"
          ...
          <div className="mt-6">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-full border border-black px-5 py-2.5 text-sm font-medium transition-transform bg-white hover:-translate-y-px"
            >
              Book Now
            </a>
          </div>
